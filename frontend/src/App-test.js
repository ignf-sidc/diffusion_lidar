...
import {  handle_mode_change } from "./hook/useHandle";
import { Menu } from "./component/Menu/Menu";
import { click_select, get_bloc, get_dalles } from "./hook/useUtils";
...
export const App = (props) => {
  ...
  const mapInstance = new Map({
    ...
    view: new View({
      ...
      center: MapState.coor_start,
      zoom: MapState.zoom_start,
      maxZoom: 16,
    }),
  });
  ...
  const createMap = (
    ...
    //Sauvegarde des intéractions dans dans le state

    setMapState({
      ...MapState,
      selectInteractionClick :selectInteractionClick,
